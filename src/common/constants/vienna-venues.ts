...
export const VIENNA_VENUES: Record<string, Coordinates> = {
  ...
  'kino am dach': { lat: 48.2025, lng: 16.3382 },
  'palais schönborn': { lat: 48.2122, lng: 16.3665 },
  'palais schonborn': { lat: 48.2122, lng: 16.3665 },
  'lucky punch comedy club': { lat: 48.2255, lng: 16.3638 },
  'lucky punch': { lat: 48.2255, lng: 16.3638 },
  'boulderbar seestadt': { lat: 48.2268, lng: 16.5078 },
  'stadioncenter': { lat: 48.2112, lng: 16.4215 },
  'stadion center': { lat: 48.2112, lng: 16.4215 },
  'himmel und wasser': { lat: 48.1755, lng: 16.4835 },
  'praterstraße 72': { lat: 48.2162, lng: 16.3888 },
  'krawall bar & deli': { lat: 48.2075, lng: 16.3768 },
  'krawall': { lat: 48.2075, lng: 16.3768 },
  'schillerpark': { lat: 48.2025, lng: 16.3648 },
  'schillerplatz': { lat: 48.2025, lng: 16.3648 },
  'peterskirche': { lat: 48.2091, lng: 16.3701 },
  'krypta, peterskirche': { lat: 48.2091, lng: 16.3701 },
  'krypta': { lat: 48.2091, lng: 16.3701 },
  'museum moderner kunst stiftung ludwig': { lat: 48.2035, lng: 16.3585 },
  'verteilerkreis favoriten': { lat: 48.1611, lng: 16.3831 },
  'verteilerkreis': { lat: 48.1611, lng: 16.3831 },
  'altes landgut': { lat: 48.1611, lng: 16.3831 },
  'seestadt': { lat: 48.2268, lng: 16.5078 },
  'maria-trapp-platz': { lat: 48.2268, lng: 16.5078 },
  'praterdome': { lat: 48.2168, lng: 16.3975 },
