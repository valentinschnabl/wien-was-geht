...
export const translations: Record<Language, Translations> = {
  de: {
    ...
    eyebrow: "WienWasGeht",
    pwaBadge: "Datensparsamer Live-Standort",
    mapTitle: "Kartenansicht Wien",
    mapSubtitle: "Zentriert auf Wien (48.2082° N, 16.3738° E) mit lokaler Distanzberechnung.",
    locateMe: "Mein Standort",
    locating: "Ortung läuft...",
    locationActive: "Standort aktiv",
    locationDenied: "Standort deaktiviert (Zentrum Wien)",
    locationUnsupported: "Standortermittlung nicht unterstützt",
    myLocation: "Ihr Standort",
    locationPrivacyNotice: "Wird ausschließlich lokal auf Ihrem Gerät verarbeitet.",

    consentTitle: "Standort für Wiener Events teilen",
    consentDescription: "Möchten Sie Ihren Standort freigeben, um tagesaktuelle Events in Ihrer direkten Wiener Umgebung nach Distanz sortiert zu sehen?",
    consentPrivacyPoint1: "Datenschutz: Ihre Koordinaten bleiben nur auf Ihrem Gerät.",
    consentPrivacyPoint2: "Kein Server-Upload: Ihr Standort wird niemals an unsere Server übertragen (DSGVO-konform / NFR-401).",
    consentPrivacyPoint3: "Freiwillig: Sie können die Karte auch ohne Freigabe uneingeschränkt nutzen.",
    consentAllow: "Standort freigeben",
    ...
    eventsTodayNotice: "Zeigt tagesaktuelle Veranstaltungen in Wien.",
    ...
    noEvents: "Keine Events für die gewählten Kriterien gefunden.",
