...
export const translations: Record<Language, Translations> = {
  de: {
    ...
    openDataNotice: "Datenquellen: Stadt Wien, Eventbrite, Ticketmaster, Eventfrog, Goodnight.at, events.at",
  ...
  en: {
    ...
    openDataNotice: "Data Sources: City of Vienna, Eventbrite, Ticketmaster, Eventfrog, Goodnight.at, events.at",
