...
export const translations: Record<Language, Translations> = {
  de: {
    ...
    openDataNotice: "Datenquellen: Stadt Wien, Resident Advisor, Eventbrite, Ticketmaster, Eventfrog, Goodnight.at, events.at, Capeet",
  ...
  en: {
    ...
    openDataNotice: "Data Sources: City of Vienna, Resident Advisor, Eventbrite, Ticketmaster, Eventfrog, Goodnight.at, events.at, Capeet",
